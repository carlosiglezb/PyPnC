...
class MultiContactDoorConfig(PlannerConfig):
    ...
    #         'torso': np.array([1.0, 1.0, 1.0] + [0.5, 0.5, 0.001]),  # (lin, ang)
    #         'feet': np.array([8.] * 3 + [0.001] * 3),  # (lin, ang)
    #         'L_knee': np.array([0.5] * 3 + [0.00001] * 3),
    #         'R_knee': np.array([0.5] * 3 + [0.00001] * 3),
    ...
    WBC_FRAME_TRACKING_GAINS = {
            'torso': np.array([0.5, 0.5, 0.3] + [0.5, 0.5, 0.001]),
            'feet': np.array([4.] * 3 + [0.00001] * 3),  # (lin, ang)
            'L_knee': np.array([2.] * 3 + [0.00001] * 3),
            'R_knee': np.array([2.] * 3 + [0.00001] * 3),
            'LH': np.array([4.] * 3 + [0.00001] * 3),
            'RH': np.array([4.] * 3 + [0.00001] * 3)
    ...
    WBC_FINAL_FRAME_TRACKING_GAINS = {
            ...
            'torso': np.array([6, 6.0, 6.0] + [1.0, 1.0, 1.]),  # (lin, ang)   step on
    ...
    WBC_WEIGHTED_COSTS = {
        ...
        'xReg': np.array([0] * 3 + [0.0] * 3 + [2.] * (N_V - 6) + [0.2] * 6 + [8.0] * (N_V - 6)), # step on balanced
        'uReg': np.array([0.4] * N_U),
        # 'uReg': np.array([0.5] * N_U),  # over, on
    }
    WBC_PHASE_END_WEIGHTED_COSTS = {
        # 'xReg': np.array([0] * 3 + [0.0] * 3 + [4.] * (N_V - 6) + [5.] * N_V),    # step on balanced
        'xReg': np.array([0] * 3 + [30.0] * 3 + [5.] * (N_V - 6) + [30.] * N_V),    # step on balanced
    }
...
class MultiContactTiltedStairsConfig(PlannerConfig):
    ...
    N_HORIZON_LST = [250, 250, 250, 250, 250, 250]
    ...
    WBC_WEIGHTED_COSTS = {
        'xReg': np.array([0] * 3 + [0.0] * 3 + [1.] * (N_V - 6) + [5.] * N_V),
