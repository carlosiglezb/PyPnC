...
class PlannerConfig(ABC):
    ...
    # ------ seq 1
    # WBP_CONTACT_JVEL_SCALE : float = 2.0   # weight on joint velocity scale of contact limb in the whole-body planner -- seq 1
    ...
    WBC_COST_WEIGHTS = {
        ...
        'friction': 2e0,    # step_over, on_balanced, step_on
