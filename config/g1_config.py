...
class SimConfig(object):
    ...
    INITIAL_POS_WORLD_TO_BASEJOINT = [0, 0, 0.63]
...
class LowLevelConfig(object):
    # Joint PD gains (37 actuated joints)
    KP_JOINT = np.array([
        20., 10., 10., 10., 20., 10.,       # left leg
        20., 10., 10., 10., 20., 10.,       # right leg
        10.,                                # torso
        10., 10., 10., 10., 10., 10.,       # left arm
        10., 10., 10., 10., 10., 10.,       # right arm
        10., 10., 10., 10., 10., 10.,       # left gripper
        10., 10., 10., 10., 10., 10.        # right gripper
    ])
    KD_JOINT = np.array([
        1.0, 0.5, 0.5, 0.5, 1.0, 0.5,       # left leg
        1.0, 0.5, 0.5, 0.5, 1.0, 0.5,       # right leg
        0.5,                                # torso
        0.5, 0.5, 0.5, 0.5, 0.5, 0.5,       # left arm
        0.5, 0.5, 0.5, 0.5, 0.5, 0.5,       # right arm
        0.5, 0.5, 0.5, 0.5, 0.5, 0.5,       # left gripper
        0.5, 0.5, 0.5, 0.5, 0.5, 0.5        # right gripper
    ])
