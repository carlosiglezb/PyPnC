...
model, collision_model, visual_model = pin.buildModelsFromUrdf(
    ...
    cwd + "/robot_model/ergoCub", pin.JointModelFreeFlyer())
...
# set to T-pose
vis_q[23] = np.pi/2 - 0.25      # left shoulder roll
vis_q[46] = np.pi/2 - 0.25      # right shoulder roll
viz.display(vis_q)
...
for ee_name in ee_list:
    plane_coeffs = []
    meshPath = cwd + "/pnc/reachability_map/output/ergoCub/" + robot_name + "_" + ee_name + ".yaml"
