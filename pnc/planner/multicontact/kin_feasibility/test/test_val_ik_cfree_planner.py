...
class TestIKCFreePlanner(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.door_pos = np.array([0.34, 0., 0.])
        ...
        self.robot = pin.RobotWrapper.BuildFromURDF(
            mesh_dir + "/" + robot_name + "_hands.urdf",
            mesh_dir,
        ...
        self.q0 = get_val_default_initial_pose(nq - 7)
    ...
    def test_five_stage_plan_feet_knee_hands(self):
        ...
        if b_use_knees:
            ...
            plan_to_model_frames = {
                ...
                'LF': 'leftFoot',
                'RF': 'rightFoot',
                'L_knee': 'leftKneePitchLink',
                'R_knee': 'rightKneePitchLink',
                'LH': 'leftWristLink',
                'RH': 'rightWristLink'
            }
        else:
